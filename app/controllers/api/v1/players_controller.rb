class Api::V1::PlayersController < ApplicationController
  def index
    player_joins = %|
      ...
      LEFT JOIN (select cause_of_deaths.player_id,cause_of_deaths.cause_of_death , dailies.date_progress from cause_of_deaths inner join dailies on cause_of_deaths.daily_id = dailies.id) as cod
